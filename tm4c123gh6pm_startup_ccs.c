// Startup code I modified from the original TI's Code Composer Studio startup
// as seen below.
//
// The original startup file contained IntDefaultHandlers for almost every 
// interrupt in the vector table. I went through and modified the important
// interrupt handlers to be named after TI's TivaWare examples.
//
// MODIFICATIONS:
//  - Added Function Prototypes for the Unique Interrupt Handlers
//  - Modified the Vector Table itself to include the function
//  - Made a "weak" dummy function with an infinite while loop for each handler
//    since we're expected to override it in the main C files.
//*****************************************************************************
//
